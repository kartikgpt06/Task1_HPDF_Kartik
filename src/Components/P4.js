...
const Post4 = () => (
    <Card style={styleCard}>
      <CardHeader style={styleCardHeader}
        title="Hasura"
        subtitle="@HasuraHQ . 9h"
        avatar={hasura1}
      />
        <CardText style={styleCardText}>
        Looking for some handy resources to get started with building a #PHP-#Apache app? Check out a ready-to-deploy #helloworld web application on http://bit.ly/2DxskC7 .  #Apps #appdev #DevOps #webdev #Developer @official_php @php_net @TheASF
      </CardText>
